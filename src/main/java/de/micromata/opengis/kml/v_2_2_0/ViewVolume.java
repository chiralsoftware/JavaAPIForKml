...
public class ViewVolume
     ...
     * <near>
     * <p>
     * <leftFov> Angle, in degrees, between the camera's viewing direction and
     * the left side of the view volume. <rightFov> Angle, in degrees, between
     * the camera's viewing direction and the right side of the view volume.
     * <bottomFov> Angle, in degrees, between the camera's viewing direction and
     * the bottom side of the view volume. <topFov>
     * Angle, in degrees, between the camera's viewing direction and the top
     * side of the view volume. <near> Measurement in meters along the viewing
     ...
     * planes define the top, bottom, left, and right sides of the field of
     * view, which has the shape of a truncated pyramid, as shown here:
     * </p>
     * <p>
     ...
     *
     * @param viewVolumeSimpleExtension Objects of the following type are
     ...
     *
     * @param viewVolumeObjectExtension Objects of the following type are
