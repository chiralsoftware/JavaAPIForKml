...
public class Pair
     ...
     * Placemark. (See <BalloonStyle>,
     * <ListStyle>, <StyleSelector>, and the styles derived from <ColorStyle>.)
     * A style defined within a Feature is called an "inline style" and applies
     * only to the Feature that contains it. A style defined as the child of a
     ...
     * @see styleSelector
     *
     * @return possible object is      {@code <}{@link Style}{@code>}
     ...
     * @see styleSelector
     *
     * @param value allowed object is      {@code <}{@link Style}{@code>}
     *     {@code <}{@link StyleSelector}{@code>}
     *     {@code <}{@link StyleMap}{@code>}
     *
     */
     ...
     *
     * @param pairSimpleExtension Objects of the following type are allowed in
     ...
     *
     * @param pairObjectExtension Objects of the following type are allowed in
