...
public class Region
     ...
     * the minimum limit of the visibility range for a given Region. Google
     * Earth calculates the size of the Region when projected onto screen space.
     * Then it computes the square root of the Region's area (if, for example,
     * the Region is square and the viewpoint is directly above the Region, and
     * the Region is not tilted, this measurement is equal to the width of the
     * projected Region). If this measurement falls within the limits defined by
     * <minLodPixels> and <maxLodPixels> (and if the <LatLonAltBox> is in view),
     * the Region is active. If this limit is not reached, the associated
     * geometry is considered to be too far from the user's viewpoint to be
     * drawn. <maxLodPixels> Measurement in screen pixels that represents the
     * maximum limit of the visibility range for a given Region. A value of −1,
     * the default, indicates "active to infinite size." <minFadeExtent>
     ...
     * the minimum end of the LOD (visibility) limits. <maxFadeExtent> Distance
     ...
     * end of the LOD (visibility) limits.
     * </p>
     *
     *
     *
    ...
    /**
     * Creates a new instance of {@link LatLonAltBox} and set it to
     * latLonAltBox.
     *
