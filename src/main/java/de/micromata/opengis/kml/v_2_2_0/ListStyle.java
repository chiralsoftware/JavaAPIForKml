...
public class ListStyle
     ...
     * are: check (default) - The Feature's visibility is tied to its item's
     * checkbox. radioFolder - When specified for a Container, only one of the
     * Container's items is visible at a time checkOffOnly - When specified for
     * a Container or Network Link, prevents all items from being made visible
     * at once—that is, the user can turn everything in the Container or Network
     * Link off but cannot turn everything on at the same time. This setting is
     * useful for Containers or Network Links containing large amounts of data.
     ...
     * checkbox allows the user to toggle visibility of the child objects in the
     * viewer.
     * </p>
     *
     *
     ...
     * <bgcolor>
     * <p>
     * Background color for the Snippet. Color and opacity values are expressed
     * in hexadecimal notation. The range of values for any one color is 0 to
     * 255 (00 to ff). For alpha, 00 is fully transparent and ff is fully
     * opaque. The order of expression is aabbggrr, where aa=alpha (00 to ff);
     * bb=blue (00 to ff); gg=green (00 to ff); rr=red (00 to ff). For example,
     ...
     * where aa=alpha (00 to ff); bb=blue (00 to ff); gg=green (00 to ff);
     * rr=red (00 to ff). For alpha, 00 is fully transparent and ff is fully
     ...
     * red=0x00. The default is opaque white (ffffffff).
     * </p>
     * <p>
     ...
     * values (no comma). <href> Specifies the URI of the image used in the List
     * View for the Feature.
     * </p>
     * <p>
     * Icon used in the List view that reflects the state of a Folder or Link
     * fetch. Icons associated with the open and closed modes are used for
