...
public class Placemark
     ...
     * @see geometry
     *
     * @return possible object is      {@code <}{@link Geometry}{@code>}
     ...
     * @see geometry
     *
     * @param value allowed object is      {@code <}{@link Geometry}{@code>}
     *     {@code <}{@link Point}{@code>}
     *     {@code <}{@link LinearRing}{@code>}
     *     {@code <}{@link Polygon}{@code>}
     *     {@code <}{@link Track}{@code>}
    ...
    public LinearRing createAndSetLinearRing() {
        final LinearRing newValue = new LinearRing();
        this.setGeometry(newValue);
        return newValue;
    }
    ...
    public Point createAndSetPoint() {
        final Point newValue = new Point();
        this.setGeometry(newValue);
        return newValue;
    }
    ...
    public Model createAndSetModel() {
        final Model newValue = new Model();
        this.setGeometry(newValue);
        return newValue;
    }
