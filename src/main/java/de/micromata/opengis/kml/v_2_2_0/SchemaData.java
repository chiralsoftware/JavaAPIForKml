...
public class SchemaData
     ...
     * example of defining two custom data elements: <Placemark> <name>Easy
     * trail</name> <ExtendedData> <SchemaData schemaUrl="#TrailHeadTypeId">
     ...
     * name attribute. The type and name of this custom data field are declared
     ...
     *
     * @param schemaDataExtension Objects of the following type are allowed in
     * the list:
