...
public class NetworkLink
     ...
     * set to 1 and the NetworkLink has <refreshVisibility>
     * set to 1. When the file is first loaded into Google Earth, the user can
     * clear the check box next to the item to turn off display in the 3D
     * viewer. However, when the NetworkLink is refreshed, the Placemark will be
     ...
     * <kml> element in the refreshed file. If the <kml> element does not have a
     * LookAt or Camera specified, the view is unchanged. For example, Google
     * Earth would fly to the <LookAt> view of the parent Document, not the
     * <LookAt> of the Placemarks contained within the Document.
     * </p>
     *
     *
     *
     ...
     * element or (b) bounding box parameters (this is the default and is used
     * if no <viewFormat>
     * element is included in the file). a second format string that is
     * specified in the
     * <httpQuery> element.
     * </p>
     *
     ...
     * @see url
     *
     * @return possible object is {@link de.micromata.opengis.kml.v_2_2_0.Link}
     *
     */
    ...
    /**
     * Creates a new instance of {@link de.micromata.opengis.kml.v_2_2_0.Link}
     * and set it to url.
     *
     ...
     *
     * @param networkLinkSimpleExtension Objects of the following type are
     ...
     *
     * @param networkLinkObjectExtension Objects of the following type are
