...
public class Document
     ...
     * KML file. <Schema> is always a child of <Document>.
     * </p>
     *
     * Syntax:
    ...
    /**
     * Creates a new instance of {@link Schema} and adds it to schema. This
    ...
    public Schema createAndAddSchema() {
        final Schema newValue = new Schema();
        this.getSchema().add(newValue);
        return newValue;
    }

    /**
     * Creates a new instance of {@link Tour} and adds it to feature. This
     * method is a short version for:      <code>
     * Tour tour = new Tour();
    ...
    public ScreenOverlay createAndAddScreenOverlay() {
        final ScreenOverlay newValue = new ScreenOverlay();
        this.getFeature().add(newValue);
        return newValue;
    }
    ...
    public PhotoOverlay createAndAddPhotoOverlay() {
        final PhotoOverlay newValue = new PhotoOverlay();
        this.getFeature().add(newValue);
        return newValue;
    }
    ...
    public GroundOverlay createAndAddGroundOverlay() {
        final GroundOverlay newValue = new GroundOverlay();
        this.getFeature().add(newValue);
        return newValue;
    }
     ...
     *
     * @param documentSimpleExtension Objects of the following type are allowed
     ...
     *
     * @param documentObjectExtension Objects of the following type are allowed
