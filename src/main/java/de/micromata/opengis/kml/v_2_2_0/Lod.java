...
public class Lod
     ...
     * active. If this limit is not reached, the associated geometry is
     ...
     * opacity=(maxLodPixels-P)/maxFadeExtent //#4 in diagram else opacity=0
     * //#5 in diagram </p>
     *
     *
     *
     ...
     *
     * @param lodSimpleExtension Objects of the following type are allowed in
     ...
     *
     * @param lodObjectExtension Objects of the following type are allowed in
