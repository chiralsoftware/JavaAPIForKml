...
public class ScreenOverlay
     ...
     * of the image. The x and y positions can be specified in different
     * ways—for example, x can be in pixels and y can be a fraction. The origin
     * of the coordinate system is in the lower left corner of the image. x -
     * Either the number of pixels, a fractional component of the image, or a
     * pixel inset indicating the x component of a point on the overlay image. y
     * - Either the number of pixels, a fractional component of the image, or a
     ...
     * indicates the x value is a fraction of the image. A value of "pixels"
     * indicates the x value in pixels. A value of "insetPixels" indicates the
     * indent from the right edge of the image. yunits - Units in which the y
     * value is specified. A value of "fraction" indicates the y value is a
     * fraction of the image. A value of "pixels" indicates the y value in
     * pixels. A value of "insetPixels" indicates the indent from the top edge
     * of the image.
     * </p>
     *
     *
     ...
     * <p>
     * For example,
     * <screenXY x=".5" y=".5" xunits="fraction" yunits="fraction"/> indicates a
     ...
     * screen. x - Either the number of pixels, a fractional component of the
     * screen, or a pixel inset indicating the x component of a point on the
     ...
     * </p>
     * <p>
     * Specifies the size of the image for the screen overlay, as follows: A
     * value of −1 indicates to use the native dimension A value of 0 indicates
     ...
     * <p>
     * To force the image to retain its original x and y dimensions, set the
     * values to −1: <size x="-1" y="-1" xunits="fraction" yunits="fraction"/>
     * To force the image to retain its horizontal dimension, but to take up 20
     * percent of the vertical screen space:
     ...
     * useful if your photo has been rotated and deviates slightly from a
