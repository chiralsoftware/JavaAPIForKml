...
public class LineString
     ...
     * To extrude a LineString, the altitude mode must be either
     * relativeToGround, relativeToSeaFloor, or absolute. The vertices in the
     * LineString are extruded toward the center of the Earth's sphere.
     * </p>
     * <p>
     ...
     * terrain. To enable tessellation, the altitude mode must be clampToGround
     * or clampToSeaFloor. Very large LineStrings should enable tessellation so
     * that they follow the curvature of the earth (otherwise, they may go
     ...
     * terrain. To enable tessellation, the Polygon must have an altitude mode
     * of clampToGround or clampToSeaFloor. Very large Polygons should enable
     * tessellation so that they follow the curvature of the earth (otherwise,
     * they may go underground and be hidden).
     * </p>
     *
     ...
     * latitude, and altitude (in that order). Longitude and latitude values are
     * in degrees, where longitude ≥ −180 and <= 180 latitude ≥ −90 and ≤ 90
     * altitude values (optional) are in meters above sea level </p> <p>
     * Do not include spaces between the three values that describe a
     * coordinate.
     * </p>
     * <p>
     * Two or more coordinate tuples, each consisting of floating point values
     * for longitude, latitude, and altitude. The altitude component is
     * optional. Insert a space between tuples. Do not include spaces within a
     * tuple.
     * </p>
     *
     *
     ...
     * @see altitudeMode
     *
     * @return possible object is      {@code <}{@link Object}{@code>}
     ...
     * @see altitudeMode
     *
     * @param value allowed object is      {@code <}{@link Object}{@code>}
     *     {@code <}{@link de.micromata.opengis.kml.v_2_2_0.AltitudeMode}{@code>}
     *     {@code <}{@link de.micromata.opengis.kml.v_2_2_0.gx.AltitudeMode}{@code>}
     *
     */
     ...
     *
     * @param lineStringSimpleExtension Objects of the following type are
     ...
     *
     * @param lineStringObjectExtension Objects of the following type are
     * allowed in the list: {@link AbstractObject}
     * @return
     * <tt>true</tt> (as general contract of <tt>Collection.add</tt>).
     */
