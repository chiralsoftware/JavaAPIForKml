...
public class BalloonStyle
     ...
     * to ff); rr=red (00 to ff). For example, if you want to apply a blue color
     ...
     * the Feature elements that use this BalloonStyle: <text>This is $[name],
     * whose description is:<br/>$[description]</text>
     * </p>
     * <p>
     ...
     * balloon. To include To here - From here driving directions in the
