...
public class NetworkLinkControl implements Cloneable {
     ...
     * of the network link. You can use this data in your script to provide more
     ...
     * been loaded using the specified URL. The <targetHref> specifies the .kml
     * or .kmz file whose data (within Google Earth) is to be modified. <Update>
     * is always contained in a NetworkLinkControl. Furthermore, the file
     * containing the NetworkLinkControl must have been loaded by a NetworkLink.
     * See the "Topics in KML" page on Updates for a detailed example of how
     * Update works.
     * </p>
     * <p>
     * With <Update>, you can specify any number of Change, Create, and Delete
     * tags for a .kml file or .kmz archive that has previously been loaded with
     * a network link. See <Update>.
     * </p>
     *
     * Syntax:
     * <pre><strong>&lt;Update&gt;
     ...
     * @see: Note: This element was deprecated in KML Release 2.1 and is
     * replaced by <Link>, which provides the additional functionality of
     * Regions. The <Url> tag will still work in Google Earth, but use of the
     * newer <Link> tag is encouraged.
     * @see: Use this element to set the location of the link to the KML file,
     * to define the refresh options for the server and viewer changes, and to
     ...
     * @see abstractView
     *
     * @return possible object is      {@code <}{@link AbstractView}{@code>}
     ...
     * @see abstractView
     *
     * @param value allowed object is      {@code <}{@link AbstractView}{@code>}
     *     {@code <}{@link LookAt}{@code>}
     *     {@code <}{@link Camera}{@code>}
     *
     */
     ...
     *
     * @param networkLinkControlSimpleExtension Objects of the following type
     * are allowed in the list: {@link Object}
     * @return
     ...
     *
     * @param networkLinkControlObjectExtension Objects of the following type
     * are allowed in the list: {@link AbstractObject}
     * @return
     * <tt>true</tt> (as general contract of <tt>Collection.add</tt>).
     */
