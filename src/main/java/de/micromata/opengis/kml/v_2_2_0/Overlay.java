...
public abstract class Overlay
     ...
     * <href>: <href>: An HTTP address or a local file specification used to
     * load an icon.
     * </p>
     * <p>
     ...
     * the location of the image to be used as the overlay or as the icon for
     * the placemark. This location can either be on a local file system or a
     * remote web server.
     * </p>
     * <p>
     ...
     *
     * @param overlaySimpleExtension Objects of the following type are allowed
     ...
     *
     * @param overlayObjectExtension Objects of the following type are allowed
