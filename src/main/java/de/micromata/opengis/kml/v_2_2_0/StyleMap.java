...
public class StyleMap
     ...
     * predefined
     * <styleUrl>. <Pair> contains two elements (both are required): <key>,
     * which identifies the key <styleUrl> or <Style>, which references the
     * style. In <styleUrl>, for referenced style elements that are local to the
     * KML document, a simple # referencing is used. For styles that are
     * contained in external files, use a full URL along with # referencing. For
     * example: <Pair> <key>normal</key>
    ...
    /**
     * Creates a new instance of {@link Pair} and adds it to pair. This method
     ...
     *
     * @param styleMapSimpleExtension Objects of the following type are allowed
     ...
     *
     * @param styleMapObjectExtension Objects of the following type are allowed
