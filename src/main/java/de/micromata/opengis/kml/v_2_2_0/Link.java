...
public class Link
     ...
     * <viewFormat>
     * tag in the file, the following information is automatically appended to
     * the query string:
     * </p>
     * <p>
     ...
     * latitude of the point that <LookAt> is viewing [lookatRange],
     * [lookatTilt], [lookatHeading] - values used by the <LookAt>
     ...
     * time it creates the query string.) The following parameters are
     * supported: [clientVersion] [kmlVersion] [clientName] [language]
     * </p>
     *
     *
     *
     ...
     *
     * @param linkSimpleExtension Objects of the following type are allowed in
     ...
     *
     * @param linkObjectExtension Objects of the following type are allowed in
